...
// 3D Icon Components - New Modern Design
const Icon3D_Compass = () => (
  <svg viewBox="0 0 64 64" className="practice-icon-3d" style={{ width: '50px', height: '50px' }}>
    <defs>
      ...
      <radialGradient id="compass-glow" cx="50%" cy="50%">
    ...
    <circle cx="32" cy="32" r="24" fill="url(#compass-glow)" opacity="0.3"/>
    <circle cx="32" cy="32" r="20" fill="url(#compass-grad)" stroke="#8B4C5C" strokeWidth="2" filter="url(#compass-shadow)"/>
...
const Icon3D_Magnet = () => (
  <svg viewBox="0 0 64 64" className="practice-icon-3d" style={{ width: '50px', height: '50px' }}>
    <defs>
      <linearGradient id="magnet-grad-1" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" style={{ stopColor: '#667EEA', stopOpacity: 1 }} />
        <stop offset="100%" style={{ stopColor: '#4C63D2', stopOpacity: 1 }} />
      </linearGradient>
      <linearGradient id="magnet-grad-2" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" style={{ stopColor: '#F093FB', stopOpacity: 1 }} />
        <stop offset="100%" style={{ stopColor: '#F5576C', stopOpacity: 1 }} />
      </linearGradient>
      <filter id="magnet-shadow">
        <feGaussianBlur in="SourceAlpha" stdDeviation="3"/>
        <feOffset dx="2" dy="4"/>
        <feComponentTransfer><feFuncA type="linear" slope="0.3"/></feComponentTransfer>
        <feMerge><feMergeNode/><feMergeNode in="SourceGraphic"/></feMerge>
    ...
    <path d="M12 32 Q12 12, 22 12 L22 32 L12 32 Z" fill="url(#magnet-grad-1)" stroke="#3A4DB8" strokeWidth="2" filter="url(#magnet-shadow)"/>
    <path d="M52 32 Q52 12, 42 12 L42 32 L52 32 Z" fill="url(#magnet-grad-2)" stroke="#C84557" strokeWidth="2" filter="url(#magnet-shadow)"/>
    <rect x="22" y="32" width="20" height="16" rx="2" fill="rgba(255,255,255,0.2)"/>
    <path d="M12 32 L22 32 L22 48 L12 48 Z" fill="url(#magnet-grad-1)" stroke="#3A4DB8" strokeWidth="2"/>
    <path d="M52 32 L42 32 L42 48 L52 48 Z" fill="url(#magnet-grad-2)" stroke="#C84557" strokeWidth="2"/>
    <circle cx="20" cy="24" r="2" fill="rgba(255,255,255,0.6)"/>
    <circle cx="44" cy="24" r="2" fill="rgba(255,255,255,0.6)"/>
  </svg>
);
...
const Icon3D_Star = () => (
  <svg viewBox="0 0 64 64" className="practice-icon-3d" style={{ width: '50px', height: '50px' }}>
    ...
    <circle cx="32" cy="28" r="22" fill="url(#star-glow)" opacity="0.4"/>
    <path d="M32 8 L36 22 L51 24 L41 34 L44 49 L32 42 L20 49 L23 34 L13 24 L28 22 Z" 
          fill="url(#star-grad)" stroke="#D4A017" strokeWidth="2" filter="url(#star-shadow)"/>
...
const Icon3D_Lock = () => (
  <svg viewBox="0 0 64 64" className="practice-icon-3d" style={{ width: '50px', height: '50px' }}>
    ...
    <rect x="18" y="28" width="28" height="22" rx="4" fill="url(#lock-grad)" stroke="#0D7A6F" strokeWidth="2" filter="url(#lock-shadow)"/>
    ...
    <path d="M22 28 L22 20 C22 14, 26 10, 32 10 C38 10, 42 14, 42 20 L42 28" 
          fill="none" stroke="url(#lock-grad)" strokeWidth="4" strokeLinecap="round" filter="url(#lock-shadow)"/>
...
const Icon3D_Folder = () => (
  <svg viewBox="0 0 64 64" className="practice-icon-3d" style={{ width: '50px', height: '50px' }}>
    ...
    <path d="M8 20 L8 48 C8 50, 10 52, 12 52 L52 52 C54 52, 56 50, 56 48 L56 24 C56 22, 54 20, 52 20 Z" 
          fill="url(#folder-grad)" stroke="#C85A7A" strokeWidth="2" filter="url(#folder-shadow)"/>
...
const bestPracticesData = [
  {
    ...
    desc: "Align datasets with the AI model's purpose.",
    icon: <Icon3D_Compass />
  },
  {
    title: "Collect Relevant Data",
    desc: "Ensure data improves robustness and accuracy.",
    icon: <Icon3D_Magnet />
  },
  {
    title: "Ensure Data Quality",
    desc: "High-quality data directly impacts model performance.",
    icon: <Icon3D_Star />
  },
  {
    title: "Maintain Ethical Standards",
    desc: "Follow privacy laws, copyright rules, and anonymization best practices.",
    icon: <Icon3D_Lock />
  },
  {
    title: "Document Data Sources",
    desc: "Guarantees transparency, reproducibility, and trustworthiness.",
    icon: <Icon3D_Folder />
  }
];
  ...
  return (
    <div className="best-practices-container">
      <div className="best-practices-header">
        <h2 className="best-practices-title">Best Practices <br /> for Data Collection in AI & ML</h2>
      </div>
